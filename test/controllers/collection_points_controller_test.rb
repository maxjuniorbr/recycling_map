...
class CollectionPointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create collection_point" do
    assert_difference("CollectionPoint.count") do
      post collection_points_url, params: { collection_point: { address: @collection_point.address, contact: @collection_point.contact, latitude: @collection_point.latitude, longitude: @collection_point.longitude, name: @collection_point.name, website: @collection_point.website } }
    end
  ...
  test "should update collection_point" do
    patch collection_point_url(@collection_point), params: { collection_point: { address: @collection_point.address, contact: @collection_point.contact, latitude: @collection_point.latitude, longitude: @collection_point.longitude, name: @collection_point.name, website: @collection_point.website } }
